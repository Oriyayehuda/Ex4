 ...
 *
 */ //משמש לאחסון ערכים קבועים בלבד משתנים הקובעים את הגודל של הגיליון והחלון הגרפי
public class Ex2Utils {
    public static final int TEXT=1, NUMBER=2, FORM=3, FUNC=4,IF=5, FUNC_ERR_FORMAT=-4, IF_ERR_FORMAT=-3, ERR_FORM_FORMAT=-2, ERR_CYCLE_FORM=-1, ERR=-1;
    public static final String ERR_CYCLE = "ERR_CYCLE!", ERR_FORM = "ERR_FORM!", ERR_FUNC = "FUNC_ERR!", ERR_IF = "IF_ERR!";
    ...
    public static final String[] M_FUNC = {"min", "max", "sum", "average"};
    public static final String IF_TEXT = "if";
    public static final String[] M_CONDITIONS = {"<", ">", "==", "<=", ">=", "!="};
